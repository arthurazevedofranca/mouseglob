...
public abstract class XMLProcessor {
	...
	public interface XMLEncodable {
		...
		IXMLEncoder getEncoder(XMLProcessor processor);

		IXMLDecoder getDecoder(XMLProcessor processor);
	}
	...
	XMLProcessor(Document document) {
		this.document = document;
	}

	protected XMLProcessor(XMLProcessor processor) {
	...
	protected static Iterable<Element> getChildren(Element element) {
